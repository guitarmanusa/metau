...
import logging
logger = logging.getLogger('metau_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by MetauWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseMetauWindow object.
        """
        builder = get_builder('MetauWindow')
        new_object = builder.get_object("metau_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a MetauWindow object with it in order to finish
        initializing the start of the new MetauWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.metau")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('metau')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for metau."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for metau."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MetauWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MetauWindow is closed."""
