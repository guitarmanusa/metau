...
DistUtilsExtra.auto.setup(
    name='metau',
    version='0.0.1-public2',
    license='GPL-3',
    author='guitarman_usa',
    author_email='guitarman_usa@yahoo.com',
    description='Easily lookup and tag your favorite mp4\'s for iTunes.',
    long_description='Easily lookup and tag your favorite mp4\'s for iTunes.\n\nThis is a GUI interface for the AtomicParsley application and a port from the MacOS X program MetaX.  The layout design and artwork are reused with the original author\'s permission.',
